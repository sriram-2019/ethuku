...
urlpatterns = [
    ...
    path('thirs',views.thirs,name='thirs'),
    ...
    path('third.html/thirs/fourth/fifth/sixth/seven',views.all_file,name='third.html/thirs/fourth/fifth/sixth/seven'),
    path('sixth',views.sixth,name='sixth'),

    path('all_files/', views.all_file, name='all_files'),
    path('send_data/', views.data, name='send_data'),
    path('seventh', views.seventh, name='send_data'),
    path('third.html/thirs/fourth/fifth/index.html',views.inde,name='third.html/thirs/fourth/fifth/sixth/index.html'),
    path('index.html',views.inde,name='index.html'),
]