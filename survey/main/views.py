...
def sixth(request):
    ...
    return render(request, 'seven.html',content)
def all_file(request):
    print("hel")
    with open("C:\\Users\\srira\\Videos\\survey\\Scanned Signed Final Syllabus on 15-12-2022.pdf", "rb") as f:
        compressed_data = f.read()
    # Now, you can work with the 'compressed_data' variable as needed
    ...
    return response
def data(request):
    print(request.POST.get("mission_option"))
